...
#
#  tm_FOUND              - If false, no tm headers were found.
#  tm_VERSION_MAJOR      - The major version tm found.
#  tm_VERSION_MINOR      - The minor version tm found.
#  tm_VERSION_PATCH      - The patch version tm found.
#  tm_VERSION_STRING     - The version string, i.e., major.minor.patch
#                          format.
#
#  tm_INCLUDE_DIRS       - List of include directories to add when compiling
#                          code using tm.
#
#  tm_LIBRARIES          - List of tm's libraries.
#
#  tm_SHARED_LIBRARIES   - List of tm's libraries as shared libraries.
#
#  tm_STATIC_LIBRARIES   - List of tm's libraries as static libraries.
#
# You can set the following variables to aid in finding tm:
#
#  TM_EXPORT_DIR         - Hints for the path leading to the CMake export file.
#                          e.g., /opt/tm-1.0.0/lib/tm, C:\tm-1.0.0\lib\tm
#
#  EXPORT_ROOT_DIR           - After TM_EXPORT_DIR, we try:
#                               ${EXPORT_ROOT_DIR}/lib/tm
#
#  TM_EXPORT_FILENAME    - The base filename of the CMake export file.
#                          e.g., Exporttm-1.cmake, Exporttm-1.0.0.cmake
#
# You may have multiple versions of tm installed. To select whichever one you
# are using, below is the recommended strategy:
#
# If you have installed tm to its own prefix, such as /opt/tm-1.0:
# set TM_EXPORT_DIR=/opt/tm-1.0/lib/tm. It will pick up the CMake export
# file at /opt/tm-1.0/lib/tm/Exporttm.cmake.
#
# If you have installed tm to a shared prefix, such as /usr/local:
# set TM_EXPORT_DIR=/usr/local/lib/tm
# set TM_EXPORT_FILENAME=Exporttm-1.0.0.cmake
# or whatever version you require.
#
# CMake 2.6 module syntax is supported.
# i.e.,
#
#  find_package(tm [<major>[.<minor>[.<patch>]]] [EXACT]
#               [QUIET] [REQUIRED])
#
#
...
set(${_p}_no_libs FALSE)
if(NOT ${_p}_no_libs)
    set(${_p}_default_lib_type "_shared")
    set(${_p}_shared_libs TRUE)
    set(${_p}_static_libs TRUE)
...
m_req_dep("${_p}" decl NOTEXACT "1.4.1" "${_p}_decl_found")
